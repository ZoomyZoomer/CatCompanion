...
const DayPopup = ({setIsPickingDate, setMonth, setYear, fetchDailies, month, year, setSelectedDay, selectedDay} : any) => {
    ...
    return (
        <Animated.View style={[styles.popup_container, animatedStyle]}>
          ...
          <View style={{marginTop: 20}}>
            <DaysPicker selectedDay={day} onSelectDay={setDay}/>
          </View>

          <TouchableOpacity style={styles.confirmButton} onPress={() => {setSelectedDay(day); setIsPickingDate(false)}}>
